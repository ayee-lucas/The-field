  ...
  return (
    <>
      <div
        ...
        className="relative flex justify-between px-3 transition-all cursor-pointer items-center w-full my-5 rounded-md bg-green-700 hover:border hover:border-black select-none"
      >
